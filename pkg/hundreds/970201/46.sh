...
docker build -t harbor.wonderland.life/wanxiang-local/game-970101:latest .
echo "docker打包ok"
docker push harbor.wonderland.life/wanxiang-local/game-970101:latest
docker rmi harbor.wonderland.life/wanxiang-local/game-970101:latest -f
