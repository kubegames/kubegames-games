...
func main() {
	...
	//开启pprof
	go func() {
		//fmt.Println("pprof start at :9877")
...
func initConfig() {
	...
	//fmt.Println(" ai rob config.json data : ", fmt.Sprintf(`%v`, config.json.AiRobConfigArr[1]))
	...
	fmt.Println("red config.json ： ", fmt.Sprintf(`%+v`, config.RedConfig))
