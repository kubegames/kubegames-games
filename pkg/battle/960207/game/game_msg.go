...
func (game *GeneralNiuniu) SendGameStatus(gameStatus int32, durationTime int32, userInter player.PlayerInterface) {
...
func (game *GeneralNiuniu) SendSceneInfo(userInter player.PlayerInterface, reConnect bool) {
	...
	for id, user := range game.UserList {
		...
		if userInter != nil && userInter.GetID() == user.ID && game.Status < int32(msg.GameStatus_ShowCards) {
...
func (game *GeneralNiuniu) SendDealCardsMsg(dealResp msg.DealRes, userInter player.PlayerInterface) {
...
func (game *GeneralNiuniu) SendShowCardsMsg(showCardsResp msg.ShowCardsRes) {
...
func (game *GeneralNiuniu) SendBetChipsInfo(betChipsInfoResp msg.BetChipsInfoRes) {
...
func (game *GeneralNiuniu) SendSettleResult(settleResultResp msg.SettleResultRes) {
...
func (game *GeneralNiuniu) SendUserExit(userExitResp msg.UserExitRes) {
...
// SendErrMsg 发送错误消息
func (game *GeneralNiuniu) SendErrMsg(errResp msg.ErrRes, userInter player.PlayerInterface) {
...
func (game *GeneralNiuniu) SendUserSitDown(userSitDownResp msg.UserSitDownRes) {
...
func (game *GeneralNiuniu) SendBetMultipleInfo(resp msg.BetMultipleRes, userInter player.PlayerInterface) {
