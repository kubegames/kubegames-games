...
// KickCheck 踢人检测
func (game *BankerNiuniu) KickCheck() {
...
// KickRobot 检测剩余机器人
func (game *BankerNiuniu) CheckLeftRobot() {
	var robotCount int
	for _, user := range game.UserList {
...
// MatchRobot 匹配机器人
func (game *BankerNiuniu) MatchRobot() {
...
// RobotSit 机器人坐下
func (game *BankerNiuniu) RobotSit() {
...
// PaoMaDeng 跑马灯
func (game *BankerNiuniu) PaoMaDeng(Gold int64, userInter player.PlayerInterface, special string) {
...
func (game *BankerNiuniu) GetSpecialSlogan(special string) int {
	switch special {
	case "牛牛":
		return 1
	case "四炸":
...
// SetChip 设置码量
func (game *BankerNiuniu) SetChip(userID int64, chip int64) {
	if chip < 0 {
		chip = -chip
	}
...
func (game *BankerNiuniu) SetExitPermit(permit bool) {
...
func (game *BankerNiuniu) TableSendRecord(userID int64, result int64, netProfit int64) (profitAmount int64, betsAmount int64, drawAmount int64, outputAmount int64) {
	var (
