...
func (game *BankerNiuniu) SendGameStatus(gameStatus int32, durationTime int32, userInter player.PlayerInterface) {
...
func (game *BankerNiuniu) SendSceneInfo(userInter player.PlayerInterface, reConnect bool) {
...
func (game *BankerNiuniu) SendDealCardsMsg(dealResp msg.DealRes, userInter player.PlayerInterface) {
...
func (game *BankerNiuniu) SendShowCardsMsg(showCardsResp msg.ShowCardsRes) {
...
func (game *BankerNiuniu) SendRobBankerInfo(robBankerInfoResp msg.RobBankerInfoRes) {
...
func (game *BankerNiuniu) SendRobBankerResult(robBankerResultResp msg.RobBankerResultRes) {
...
func (game *BankerNiuniu) SendBetChipsInfo(betChipsInfoResp msg.BetChipsInfoRes) {
...
func (game *BankerNiuniu) SendSettleResult(settleResultResp msg.SettleResultRes) {
...
func (game *BankerNiuniu) SendUserExit(userExitResp msg.UserExitRes) {
...
// SendErrMsg 发送错误消息
func (game *BankerNiuniu) SendErrMsg(errResp msg.ErrRes, userInter player.PlayerInterface) {
...
func (game *BankerNiuniu) SendUserSitDown(userSitDownResp msg.UserSitDownRes) {
...
func (game *BankerNiuniu) SendBetMultipleInfo(resp msg.BetMultipleRes, userInter player.PlayerInterface) {
