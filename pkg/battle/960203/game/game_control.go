...
// Control 控制牌
func (game *WatchBanker) Control() {
	// 设置牌组序列
	game.SetCardsSequence()

	// 点控
	//game.PrecisionControl()
...
func (game *WatchBanker) SetCardsSequence() {
...
func (game *WatchBanker) ControlBiggerCards() {
...
// 检测作弊率
func (game *WatchBanker) checkProb(prob int32) (probIndex int) {
	probIndex = -1
