...
type TimeConfig struct {
	...
	FirstDealAnimation  int `json:"first_deal_animation"`  // 第一次单人发牌动画时间
...
// WatchBankerConfig 牛牛配置
type WatchBankerConfig struct {
...
// WatchBankerConf 看牌抢庄牛牛配置
var WatchBankerConf WatchBankerConfig

// RobotConf 机器人配置
var RobotConf RobotConfig

// LoadBlackjackCfg 读取配置文件
func (conf *WatchBankerConfig) LoadWatchBankerCfg() {
	data, err := ioutil.ReadFile("conf/watchBanker.json")
	if err != nil {
