...
import (
	...
	"github.com/kubegames/kubegames-games/pkg/slots/990401/gamelogic"
...
func (tres *testres) freegame(odds int) {
	...
	arr := [...]int{0, lineNum * 1, lineNum * 3, lineNum * 5, lineNum * 10, lineNum * 30, lineNum * 50, lineNum * 100, lineNum * 200, 99999999}
...
func (tres *testres) normalgame(odds int) {
	...
	arr := [...]int{0, lineNum * 1, lineNum * 3, lineNum * 5, lineNum * 10, lineNum * 30, lineNum * 50, lineNum * 100, lineNum * 199, 99999999}
