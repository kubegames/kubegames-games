...
func Load() { //(/\*([^*]|[\r\n]|(\*+([^*/]|[\r\n])))*\*+/|[ \t]*//.*)  去掉注释的正则
	...
	if err == nil {
		...
		if err != nil {
			log.Errorln("shuaxin conf err", err)
			return
		}
		s, _ := shuaxin.Map()
		YuConf.Set("2", s)
	...
	if err == nil {
		...
		if err != nil {
			log.Errorln("changjin conf err", err)
			return
		}
	}
	...
	if err == nil {
		...
		if err != nil {
			log.Errorln("paodan conf err", err)
			return
		}
	}
	...
	if err == nil {
		...
		if err != nil {
			log.Errorln("robot conf err", err)
			return
		}
	}
	...
	if err == nil {
		...
		f, err := formation.Map()
		if err != nil {
			log.Errorln("FormationConf conf err", err)
			return
		}
	...
	if err == nil {
		...
		if err != nil {
			log.Errorln("PoolConf conf err", err)
			return
		}
	}
	...
	if err == nil {
		...
		if err != nil {
			log.Errorln("SkillConf conf err", err)
			return
		}
	}
	loadFishLine()
...
func loadFishType() {
	...
	for _, k := range keys {
		...
		if err != nil {
			log.Errorln("leixing err", err)
			return
		}
		id, err := v.Get("Id").String()
		if err != nil {
			log.Errorln("Id err", err)
			return
		}
...
func GetFishTideTime() int {
	...
	if err != nil {
		log.Errorln("fishTideTime err", err)
	}
	return length
}
...
func GetFishTideForecastTime() int {
	...
	if err != nil {
		log.Errorln("fishTideForecastTime err", err)
	}
	return length
}
...
func GetFishNumChance(fishId string) int32 {
	...
	if err != nil {
		log.Errorln("Num chance err ", err)
	}
	return int32(speed)
}
...
func GetFishTime(fishId string) int {
	...
	if err != nil {
		log.Errorln("yuqun time err ", err)
	}
	return speed
}
...
func GetFishScore(fishId string) int32 {
	...
	if err != nil {
		log.Errorln("Score err ", err)
	}
	return int32(speed)
}

func GetBossFishScore(fishId string) []interface{} {
	speed, err := GetFish(fishId).Get("fenzhi2").Array()
	if err != nil {
		log.Errorln("Boss Score err ", err)
	}
	return speed
}

func GetBossFishScoreChance(fishId string) []interface{} {
	speed, err := GetFish(fishId).Get("quanzhong").Array()
	if err != nil {
		log.Errorln("quanzhong err ", err)
	}
	return speed
}
...
func GetFishTideSustainTime(key string) int {
	...
	if err != nil {
		log.Errorln("FishTideSustainTime err ", err)
	}
...
func GetFishHitChance(fishId string, isRobot bool) int32 {
	if isRobot {
		...
		if err != nil {
			log.Errorln("robot HitChance err ", err)
		}
		return int32(speed)
	}
	speed, err := GetFish(fishId).Get("gailv").Int()
	if err != nil {
		log.Errorln("HitChance err ", err)
	}
	return int32(speed)
}
...
func GetFishBet(cfg string, lv int32) int32 {
	...
	if err != nil {
		log.Errorln("bet err", err)
		return 0
	}
	bet, err := j.Get("Bottom_Pouring").Int()
	if err != nil {
		log.Errorln("bet err ", err)
	}
	return int32(bet) * lv
...
func GetSceneBossFishCap(islandId, key string) map[msg.Type]int {
	...
	if err != nil {
		log.Errorln("bosszuidabeishu nil", err)
	}
	up, err := scene.Get(key).Get("bosspubl").Int()
	if err != nil {
		log.Errorln("bosspubl nil", err)
	}
	all = all + all*up/100
	small, err := scene.Get(key).Get("bossxiaoyu").Int()
	if err != nil {
		log.Errorln("boss small cap nil", err)
	}
	middle, err := scene.Get(key).Get("bosszhongyu").Int()
	if err != nil {
		log.Errorln("boss middle cap nil", err)
	}
	big, err := scene.Get(key).Get("bossdayu").Int()
	if err != nil {
		log.Errorln("boss big cap nil", err)
	}
	fishCap[msg.Type_SPECIAL] = int(GetFishScore(GetBossId(islandId, key)))
	fishCap[msg.Type_SMALL] = all * small / 100
	fishCap[msg.Type_MIDDLE] = all * middle / 100
...
func GetShotoffTime() int {
	...
	if err != nil {
		log.Errorln("ShotoffTime err", err)
	}
	return t
}
...
func GetFishType(fishId string) msg.Type {
	...
	if err != nil {
		log.Errorln("get fishtype err", err)
	}
...
func GetSkillHitNum(fishId string, skillId int32, duration int64, mult int32) int {
	...
	if err != nil {
		log.Errorln("skill hit num err", err)
	}
	return num
}
...
func GetSkillDur(fishId string, skillId int32) int64 {
	...
	if err != nil {
		log.Errorln("skill time err", err)
	}
	return int64(num)
}
...
func GetSkillFishNum(fishId string, skillId int32) int {
	...
	if err != nil {
		log.Errorln("skill hit fish num err", err)
	}
	return num
}
...
func GetRefreshTime() int {
	...
	if err != nil {
		log.Errorln("refresh time err ", err)
	}
	return t
}
...
func GetRoundTime() int {
	...
	if err != nil {
		log.Errorln("round time err ", err)
	}
	return t
}
...
func GetSaveScoreTime() int {
	...
	if err != nil {
		log.Errorln("saveScoreTime time err ", err)
	}
	return t
}
...
func GetRobotInitShootNum() int {
	...
	if err != nil {
		log.Errorln("robot init shoot num err", err)
	}
	return num
}
...
func GetRobotIsFixed() int32 {
	...
	if err != nil {
		log.Errorln("robot isfixed err", err)
	}
	return int32(num)
}
...
func GetRobotLimit() int32 {
	...
	if err != nil {
		log.Errorln("robot robot limit err", err)
	}
	return int32(num)
}
...
func GetRobotChangeTime() int32 {
	...
	if err != nil {
		log.Errorln("robot shoot time err", err)
	}
	return int32(num)
}
...
func GetRobotRandChangeTime() int32 {
	...
	if err != nil {
		log.Errorln("robot rand shoot time err", err)
	}
	return int32(num)
}
...
func GetRobotWinChangeCoin() int64 {
	...
	if err != nil {
		log.Errorln("robot win coin change err", err)
	}
	return int64(num)
}
...
func GetRobotWinChangeLimit() []interface{} {
	...
	if err != nil {
		log.Errorln("robot win limit err", err)
	}
	return num
}
...
func GetRobotLoseChangeCoin() int64 {
	...
	if err != nil {
		log.Errorln("robot lose change coin err", err)
	}
	return int64(num)
}
...
func GetRobotLoseChangeLimit() []interface{} {
	...
	if err != nil {
		log.Errorln("robot lose limit err", err)
	}
	return num
}
...
func GetRobotLockTime() int {
	...
	if err != nil {
		log.Errorln("robot lock time err", err)
	}
	return num
}
...
func GetRobotShootLimit() int {
	...
	if err != nil {
		log.Errorln("robot shoot limit err", err)
	}
	return num
}
...
func GetRobotRestSpace() int {
	...
	if err != nil {
		log.Errorln("robot rest space err", err)
	}
...
func GetRobotRestTime() int {
	...
	if err != nil {
		log.Errorln("robot rest time err", err)
	}
	min := num[0].(int)
	max := num[1].(int)
	return tools.RandInt(min, max, 0)
...
func GetBossAddTime() int {
	...
	if err != nil {
		log.Errorln("bossAddTime err", err)
	}
	return num
}
...
func GetSkillAddTime() int {
	...
	if err != nil {
		log.Errorln("skillAddTime err", err)
	}
	return num
}
...
func GetRobotQuitTime() int {
	...
	if err != nil {
		log.Errorln("robot quit time err", err)
	}
	return num
}
...
func GetRobotQuitCoin() int {
	...
	if err != nil {
		log.Errorln("robot quit coin err", err)
	}
	return num
}
...
func GetRobotLockChance() int {
	...
	if err != nil {
		log.Errorln("robot lock chance err", err)
	}
	return num
}
func GetRobotSkillFrozenChance() int {
	...
	if err != nil {
		log.Errorln("robot skillFrozenChance err", err)
	}
	return num
}
...
func GetRobotSkillFrozenCheckTime() int {
	...
	if err != nil {
		log.Errorln("robot skillFrozenCheckTime err", err)
	}
	return num
}
...
func GetRobotSkillSummonCheckChance() int {
	...
	if err != nil {
		log.Errorln("robot skillSummonChance err", err)
	}
	return num
}
...
func GetRobotSkillSummonCheckTime() int {
	...
	if err != nil {
		log.Errorln("robot skillSummonCheckTime err", err)
	}
	return num
}
...
func GetRobotLockModelChance() int {
	...
	if err != nil {
		log.Errorln("robot lockModelChance err", err)
	}
	return num
}
...
func GetRobotModelCheckTime() int {
	...
	if err != nil {
		log.Errorln("robot modelCheckTime err", err)
	}
	return num
}
...
func GetRobotLockCheckTime() int {
	...
	if err != nil {
		log.Errorln("robot LockCheckTime err", err)
	}
	return num
}
...
func GetRobotLockFishes(fishId string) bool {
	...
	if err != nil {
		log.Errorln("robot check lock fish err", err)
	}
...
func GetFormationTime(islandId, sceneId string) int {
	...
	if err != nil {
		log.Errorln("Formationtime err", err)
	}
	return t
}
...
func GetAFormationFile(islandId, sceneId string) string {
	...
	if err != nil {
		log.Errorln("FormationFile err", err)
		return ""
	}
...
func GetAFormationKey(file string) string {
	...
	if err != nil {
		log.Errorln("formations err", err)
		return ""
	}
	keys := make([]string, 0)
...
func GetTimeFish() map[string]interface{} {
	...
	if err != nil {
		log.Errorln("all timeFish err", err)
	}
...
func GetXueChiChance(fishId, roomKey string, key int32) int32 {
	...
	if err != nil {
		log.Errorln("xuechi chance err", err)
	}
	return int32(chance)
}
...
func GetSummonFishId() string {
	...
	if err != nil {
		log.Errorln("summon fishId err", err)
		return ""
	}
	return all[tools.RandInt(0, len(all), 0)].(string)
}
...
func GetSummonFishLine() ([]interface{}, []interface{}, interface{}, interface{}, int) {
	...
	if err != nil {
		log.Errorln("summon line err", err)
	}
	return GetLine(lines)
}
...
func GetBossTurnInfo(islandId, sceneId string, lastIndex int) ([]interface{}, int) {
	...
	if err != nil {
		log.Errorln("bosschushoupeizhi err", err)
	}
	index := 0
	for i := 0; i < 100; i++ {
...
func GetBossTurnTime(islandId, sceneId string) int {
	...
	if err != nil {
		log.Errorln("bossyuzhuanxiangshijian err", err)
	}
	return t
}
...
func GetBossTurnChance(islandId, sceneId string) int32 {
	...
	if err != nil {
		log.Errorln("bosszhunxianggailv err", err)
	}
	return int32(chance)
}
