...
import (
	...
	"github.com/kubegames/kubegames-games/pkg/fishing/980301/data"
...
func (table *TableLogic) changeFishLine(fish *Fish) {
	...
	table.boss[fish.info.GetId()] = fish
	delete(table.Fishes, oldFishId)
	delete(table.boss, oldFishId)
	if table.FishTide {
		return
	}
