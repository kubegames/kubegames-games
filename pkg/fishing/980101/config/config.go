...
func GetRobotSpeedChance() int {
	num, err := RobotConf.Get("1").Get("1").Get("skillSpeedChance").Int()
	if err != nil {
		log.Errorf("robot skillSpeedChance err", err)
	}
	return num
}

func GetRobotSpeedCheckTime() int {
	num, err := RobotConf.Get("1").Get("1").Get("skillSpeedCheckTime").Int()
	if err != nil {
		log.Errorf("robot skillSpeedCheckTime err", err)
	}
	return num
}

func GetRobotLockCheckTime() int {
	num, err := RobotConf.Get("1").Get("1").Get("checkLockTime").Int()
	if err != nil {
		log.Errorf("robot checkLockTime err", err)
	}
	return num
}
